...
#
#  Onglet migre en module Shiny (7e migration -- le plus volumineux).
#  Lit values$filteredData (donnee partagee) et gere son propre etat de
#  graphique (plotData, customXOrder, storedLevelLabels, etc.) dans le
#  reactiveValues GLOBAL passe par reference. Helpers de graphique (get_x_scale,
#  get_plot_theme, get_date_display_fmt) inclus dans le module.
#  - mod_viz_ui(id)             : contenu de l'onglet
#  - mod_viz_server(id, values) : 'values' = reactiveValues GLOBAL
################################################################################

...
#
#  Onglet migre en module Shiny (6e migration). Lit les donnees partagees et
#  ecrit son resultat values$descStats. Le calcul exact sur jeu complet (DuckDB)
#  est conserve. La gestion de l'echantillon de travail (sampleInfoLine /
#  redrawSample) reste dans le serveur principal car son UI est dans l'onglet
#  Chargement (hors module).
#  - mod_descriptive_ui(id)             : contenu de l'onglet
#  - mod_descriptive_server(id, values) : 'values' = reactiveValues GLOBAL
################################################################################

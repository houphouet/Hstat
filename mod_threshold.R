...
#
#  Onglet autonome migre en module Shiny (preuve de concept de modularisation).
#  - mod_threshold_ui(id)        : contenu de l'onglet (a placer dans un tabItem)
#  - mod_threshold_server(id, values) : logique serveur ; 'values' est le
#    reactiveValues GLOBAL de l'application (fournit values$data, values$filteredData).
#
#  Les identifiants input/output sont automatiquement namespaces par le module :
#  aucun renommage cote serveur n'est necessaire. Cote UI, chaque id est
#  enveloppe par ns().
################################################################################

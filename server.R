################################################################################
#
#             LOGIQUE SERVER DE L'APPLICATION HStat
#
################################################################################
...
server <- function(input, output, session) {
  ...
  generate_desc_plot <- function() {
    ...
    # Style de police pour le label du titre
    ...
    # Style de police pour le label de l'axe X
    ...
    # Style de police pour le label de l'axe Y
    ...
    # Style de police pour les graduations de l'axe X
    ...
    # Style de police pour les graduations de l'axe Y
    ...
    # Angle d'inclinaison pour les gaduations de l'axe X
  ...
  # Actions pour les labels de légende
  ...
  # Génération de la visualisation avec support Y multiple
  observeEvent(input$generateViz, {
    ...
    tryCatch({
      ...
      # Appliquer les étiquettes personnalisées pour X 
      x_type <- if(input$xVarType == "auto") values$detectedXType else input$xVarType
